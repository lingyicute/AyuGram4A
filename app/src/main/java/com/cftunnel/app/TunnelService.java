...
public class TunnelService extends Service {
    public static final String ACTION_START = "com.cftunnel.app.action.START";
    public static final String ACTION_STOP = "com.cftunnel.app.action.STOP";
    public static final String ACTION_STOP_ALL = "com.cftunnel.app.action.STOP_ALL";
